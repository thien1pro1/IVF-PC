      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            <img style="width: 100px" src="{{asset('backend/img/logo.png')}}">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="../pages/dashboard.html">
                  TRANG QUẢN TRỊ IVF PHƯƠNG CHÂU
            </a>
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h4 class="font-weight-bolder text-info text-gradient">IVF PHƯƠNG CHÂU XIN CHÀO!</h4>
                ...
                <div class="card-body">
                  <form id="admin-login" method="POST" action="{{ route('login') }}">
                    ...
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" aria-label="Email" aria-describedby="email-addon"  class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('password')
                    ...
                    <div class="mb-3">
                      <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" aria-label="Password" name="password" aria-describedby="password-addon">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="text-center">
                      <!-- <input type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign in</button> -->
