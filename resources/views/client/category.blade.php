...
@section('content')
  ...
  <title>Blog posts &#8211; Dentition &#8211; Medical Category WordPress Theme</title>
...
<link rel="https://api.w.org/" href="https://wp.w3layouts.com/dentition/wp-json/" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://wp.w3layouts.com/dentition/xmlrpc.php?rsd" />
...
<body id="top-gap-fixed-header" class="blog hfeed no-sidebar">
...
<section class="inner-banner py-5">
  ...
  <div class="w3l-breadcrumb py-lg-5">
    <div class="container pt-4 pb-sm-4 BlogPageBanner">
        ...
        {{$category->categogyName}}</h4>
      
                  <ul class="breadcrumbs-custom-path AllBreadcrumbs">
        <a href="{{url('/client/home')}}" rel="nofollow">Trang chủ</a>      </ul>
          </div>
  </div>
</section>
<!-- //inner banner -->
...
<main id="primary" class="site-main">
  ...
  <div class="w3l-homeblock2 py-5">
    <div class="container py-md-5 py-4">
                  ...
                  <h3 class="title-style text-center mb-4 BlogPageHeader">
                <!-- <span>Blog</span> -->
        {{$category->categogyName}}</h3>
...
<div class="col-lg-6 mt-3">
  ...
  <article id="post-1" class="post-1 post type-post status-publish format-standard has-post-thumbnail hentry category-medical">
    ...
    <div class="bg-clr-white hover-box">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-sm-6 position-relative">
          <a href="https://wp.w3layouts.com/dentition/2022/03/10/hello-world/">
            
      <a class="post-thumbnail" href="{{route('page.post',[$post->id])}}" aria-hidden="true" tabindex="-1">
        <img width="640" height="800" src="{{asset('uploads/'.$post->image)}}" />      </a>
        ...
        <div class="col-sm-6">
          <div class="card-body blog-details align-self pl-sm-0">
            ...
            <div class="d-flex align-items-center justify-content-between mt-lg-4 mt-5">
                                          ...
                                          <h5 class="text-blog-e">{{$post->created_at}}</h5>
...
@endforeach
  ...
  <li><a class="page-numbers" href="https://wp.w3layouts.com/dentition/blog-posts/page/2/">2</a></li>
  <li><a class="next page-numbers" href="https://wp.w3layouts.com/dentition/blog-posts/page/2/">Next</a></li>
</ul>
          </nav>
        </div>
      </div>
