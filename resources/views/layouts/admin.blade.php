...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('backend/img/down-arrow')}}">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{route('admin.dashboard')}}" target="_blank">
        <img  src="{{asset('backend/img/logo-02.jpg')}}" class="navbar-brand-img h-100')}}" alt="main_logo">
        <span style="font-size:20px" class="ms-1 font-weight-bold">Trang quản trị</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="{{route('admin.dashboard')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <img width="20px" height="20px" src="{{asset('images/icon/home-01.png')}}">
          ...
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quản lý khách hàng </h6>
        </li>
        @if(Auth::user()->position_id!=2)
        <li class="nav-item">
          <a class="nav-link  " href="{{route('client.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <img width="20px" height="20px" src="{{asset('images/icon/customer.png')}}">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        @if(Auth::user()->position_id==2 || (Auth::user()->position_id==0))
                <li class="nav-item">
          <a class="nav-link  " href="{{route('bookStaff.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <img width="20px" height="20px" src="{{asset('images/icon/calendar.png')}}">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
            ...
            <span class="nav-link-text ms-1">Lịch khám</span>
          </a>
        </li>
        @endif
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('ask.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <img width="20px" height="20px" src="{{asset('images/icon/reception.png')}}">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('calendar.show',['1'])}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <img width="20px" height="20px" src="{{asset('images/icon/medicine.png')}}">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">xem lịch trực</span>
          </a>
        </li>
        @endif
        ...
        @if(Auth::user()->position_id!=2)
         <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quản lý dịch vụ </h6>
        </li>
                <li class="nav-item">
          <a class="nav-link  " href="{{route('service.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <img width="20px" height="20px" src="{{asset('images/icon/service.png')}}">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('position.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <img width="20px" height="20px" src="{{asset('images/icon/duty.png')}}">
         ...
         <li class="nav-item">
          <a class="nav-link  " href="{{route('staff.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
               <img width="20px" height="20px" src="{{asset('images/icon/medical-team.png')}}">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-2169.000000, -745.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('categogy.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <img width="20px" height="20px" src="{{asset('images/icon/menu.png')}}">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('post.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
             <img width="20px" height="20px" src="{{asset('images/icon/post.png')}}">
            ...
            <span class="nav-link-text ms-1">Bài viêt</span>
          </a>
        </li>
        @endif
      </ul>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
                ...
                <i>
                  <img style="width: 35px ; border-radius: 5px ;height: 35px;" src="{{asset('uploads/'.Auth::user()->image)}}" >
                </i>
                <span class="d-sm-inline d-none"></span>
                                            <li style="margin-top: 5px;" class="nav-item dropdown">
                                <a  id="navbarDropdown"  class="nav-link dropdown-toggle d-sm-inline d-none" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                  {{ Auth::user()->name }}
                                </a>
